    ...
    , ui(new Ui::MainWindow)
{
    ...
    //搜索框样式表
    ui->cityLineEdit->setStyleSheet("QLineEdit{border: 1px solid gray; border-radius: 4px; "
                                    "background:argb(47, 47, 47, 130); color:rgb(255, 255, 255);} "
